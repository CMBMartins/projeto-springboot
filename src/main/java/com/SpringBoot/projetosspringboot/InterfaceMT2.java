...
public class InterfaceMT2 extends JFrame implements ActionListener {
    ...
    public InterfaceMT2() {
        ...
        setTitle("Barramento de 34.5 kV MT-2");
        setSize(1120, 810);
        ...
        l1.setText("MT-2 Barramento de 34,5 kV");
        ...
        barra1 = new JLabel("Barra T2"); // IDENTIFICA��O DA BARRA T2
        ...
        JPanel v13 = new JPanel(); // SECCIONADORA 89 LVR-2A
        v13.setBounds(865, 8, 3, 55);
        v13.setBackground(Color.orange);
        painel.add(v13);

        JPanel v14 = new JPanel(); // SECCIONADORA 89 LVR-2A / DISJUNTOR 52 LVR-2A
        v14.setBounds(865, 103, 3, 23);
        v14.setBackground(Color.orange);
        painel.add(v14);

        JPanel v15 = new JPanel(); // SECCIONADORA 89 LVR-2AE
        v15.setBounds(950, 30, 3, 33);
        v15.setBackground(Color.orange);
        painel.add(v15);

        JPanel v16 = new JPanel(); // SECCIONADORA 89 LVR-2A / DISJUNTOR
        v16.setBounds(950, 103, 3, 23);
        v16.setBackground(Color.orange);
        painel.add(v16);

        JPanel v18 = new JPanel(); // SECCIONADORA 89 LVR-2A / SECCIONADORA 89 LVR-2AE
        ...
        JPanel v17 = new JPanel(); // DISJUNTOR / TRANSFORMADOR LVR-2A
        v17.setBounds(907, 185, 3, 123);
        v17.setBackground(Color.orange);
        painel.add(v17);

        JPanel v20 = new JPanel(); // TRANSFORMADOR / RETIFICADOR R12
        ...
        JPanel v2 = new JPanel(); // Seccionadora 89 C4
        v2.setBounds(155, 8, 3, 55);
        v2.setBackground(Color.orange);
        painel.add(v2);

        JPanel v3 = new JPanel();
        v3.setBounds(155, 103, 3, 23); // Seccionadora 89 C4 / Disjuntor
        v3.setBackground(Color.orange);
        painel.add(v3);

        JPanel v4 = new JPanel(); // Seccionadora 89 C4-E
        v4.setBounds(240, 30, 3, 33);
        v4.setBackground(Color.orange);
        painel.add(v4);

        JPanel v5 = new JPanel(); // SECCIONADORA 89 C4-E / DISJUNTOR C4
        v5.setBounds(239, 103, 3, 23);
        v5.setBackground(Color.orange);
        painel.add(v5);

        JPanel v7 = new JPanel(); // SECCIONADORA C4 / SECCIONADORA C4-E
        ...
        JPanel v86 = new JPanel(); // Seccionadora 89 C3
        v86.setBounds(5, 8, 3, 55);
        v86.setBackground(Color.orange);
        painel.add(v86);

        JPanel v87 = new JPanel();
        v87.setBounds(5, 103, 3, 23); // Seccionadora 89 C3 / Disjuntor
        v87.setBackground(Color.orange);
        painel.add(v87);

        JPanel v88 = new JPanel(); // Seccionadora 89 C3-E
        v88.setBounds(90, 30, 3, 33);
        v88.setBackground(Color.orange);
        painel.add(v88);

        JPanel v89 = new JPanel(); // SECCIONADORA 89 C3-E / DISJUNTOR C3
        v89.setBounds(89, 103, 3, 23);
        v89.setBackground(Color.orange);
        painel.add(v89);

        JPanel v91 = new JPanel(); // SECCIONADORA C3 / SECCIONADORA C3-E
        ...
        JPanel v22 = new JPanel(); // SECCIONADORA 89 LVR-2
        v22.setBounds(715, 8, 3, 55);
        v22.setBackground(Color.orange);
        painel.add(v22);

        JPanel v23 = new JPanel();
        v23.setBounds(715, 103, 3, 23); // Seccionadora 89 LVR-2 / Disjuntor
        v23.setBackground(Color.orange);
        painel.add(v23);

        JPanel v24 = new JPanel(); // Seccionadora 89 LVR-2E
        v24.setBounds(800, 30, 3, 33);
        v24.setBackground(Color.orange);
        painel.add(v24);

        JPanel v25 = new JPanel(); // SECCIONADORA 89 LVR-2 / DISJUNTOR 52 LVR-2
        v25.setBounds(800, 103, 3, 23);
        v25.setBackground(Color.orange);
        painel.add(v25);

        JPanel v26 = new JPanel(); // DISJUNTOR / TRAFO LVR-2
        v26.setBounds(760, 185, 3, 65);
        v26.setBackground(Color.orange);
        painel.add(v26);

        JPanel v27 = new JPanel(); // SECCIONADORA LVR-2 / SECCIONADORA LVR-2E
        ...
        JPanel v44 = new JPanel(); // TRANSFORMADOR / BARRA R2
        ...
        v30.setBounds(590, 103, 3, 23); // Seccionadora 89 P3 / Disjuntor
        v30.setBackground(Color.orange);
        painel.add(v30);

        JPanel v31 = new JPanel(); // Seccionadora 89 P3-E
        v31.setBounds(675, 30, 3, 33);
        v31.setBackground(Color.orange);
        painel.add(v31);

        JPanel v32 = new JPanel(); // SECCIONADORA 89 P3-E / DISJUNTOR 52 P3
        ...
        JPanel v34 = new JPanel(); // SECCIONADORA P3 / SECCIONADORA P3-E
        ...
        v81.setBounds(465, 103, 3, 23); // Seccionadora 89 P4 / Disjuntor
        v81.setBackground(Color.orange);
        painel.add(v81);

        JPanel v82 = new JPanel(); // Seccionadora 89 P4-E
        v82.setBounds(550, 30, 3, 33);
        v82.setBackground(Color.orange);
        painel.add(v82);

        JPanel v83 = new JPanel(); // SECCIONADORA 89 P4-E / DISJUNTOR 52 P4
        v83.setBounds(550, 103, 3, 23);
        v83.setBackground(Color.orange);
        painel.add(v83);

        JPanel v85 = new JPanel(); // SECCIONADORA P4 / SECCIONADORA P4-E
        ...
        v37.setBounds(305, 103, 3, 23); // Seccionadora 89 A3 / Disjuntor 52 A3
        v37.setBackground(Color.orange);
        painel.add(v37);

        JPanel v38 = new JPanel(); // Seccionadora 89 A3-E
        v38.setBounds(390, 30, 3, 33);
        v38.setBackground(Color.orange);
        painel.add(v38);

        JPanel v39 = new JPanel(); // SECCIONADORA 89 A3-E / DISJUNTOR 52 A3
        v39.setBounds(390, 103, 3, 23);
        v39.setBackground(Color.orange);
        painel.add(v39);

        JPanel v41 = new JPanel(); // SECCIONADORA 89 A3 / DISJUNTOR 52 P2
        v41.setBounds(350, 125, 3, 20);
        v41.setBackground(Color.orange);
        painel.add(v41);

        JPanel v42 = new JPanel(); // SECCIONADORA 89 P2 / SECCIONADORA 89 A3-E
        v42.setBounds(305, 125, 88, 3);
        v42.setBackground(Color.orange);
        painel.add(v42);

        JPanel v43 = new JPanel(); // DISJUNTOR / ALIMENTADOR A3
        ...
        JPanel v50 = new JPanel(); // SECCIONADORA 89 R12-E / DISJUNTOR 52 R12
        v50.setBounds(145, 445, 3, 23);
        v50.setBackground(Color.yellow);
        painel.add(v50);

        JPanel v52 = new JPanel(); // SECCIONADORA R12 / SECCIONADORA R12-E
        ...
        JPanel v51 = new JPanel(); // DISJUNTOR / TRAFO RF-12
        ...
        v55.setBounds(210, 445, 3, 24); // Seccionadora 89 R11 / Disjuntor
        v55.setBackground(Color.yellow);
        painel.add(v55);

        JPanel v56 = new JPanel(); // Seccionadora 89 R11-E
        v56.setBounds(295, 375, 3, 28);
        v56.setBackground(Color.yellow);
        painel.add(v56);

        JPanel v57 = new JPanel(); // SECCIONADORA 89 R11-E / DISJUNTOR 52 R11
        v57.setBounds(295, 445, 3, 23);
        v57.setBackground(Color.yellow);
        painel.add(v57);

        JPanel v58 = new JPanel(); // SECCIONADORA R11 / SECCIONADORA R11-E
        ...
        JPanel v60 = new JPanel(); // DISJUNTOR / TRAFO RF-11
        ...
        // ���������������������������������������������� BAY RF 10
        // ���������������������������������������������
        JPanel v61 = new JPanel(); // SECCIONADORA 89 R10
        v61.setBounds(360, 350, 3, 53);
        v61.setBackground(Color.yellow);
        painel.add(v61);

        JPanel v62 = new JPanel();
        v62.setBounds(360, 445, 3, 24); // Seccionadora 89 R10 / Disjuntor
        v62.setBackground(Color.yellow);
        painel.add(v62);

        JPanel v63 = new JPanel(); // Seccionadora 89 R10-E
        v63.setBounds(445, 375, 3, 28);
        v63.setBackground(Color.yellow);
        painel.add(v63);

        JPanel v64 = new JPanel(); // SECCIONADORA 89 R10-E / DISJUNTOR 52 R10
        v64.setBounds(445, 445, 3, 23);
        v64.setBackground(Color.yellow);
        painel.add(v64);

        JPanel v65 = new JPanel(); // SECCIONADORA R10 / SECCIONADORA R10-E
        ...
        JPanel v67 = new JPanel(); // DISJUNTOR / TRAFO RF-10
        ...
        v95.setBounds(510, 445, 3, 24); // Seccionadora 89 R09 / Disjuntor
        v95.setBackground(Color.yellow);
        painel.add(v95);

        JPanel v96 = new JPanel(); // Seccionadora 89 R09-E
        v96.setBounds(595, 375, 3, 28);
        v96.setBackground(Color.yellow);
        painel.add(v96);

        JPanel v97 = new JPanel(); // SECCIONADORA 89 R09-E / DISJUNTOR 52 R09
        v97.setBounds(595, 445, 3, 23);
        v97.setBackground(Color.yellow);
        painel.add(v97);

        JPanel v98 = new JPanel(); // SECCIONADORA R09 / SECCIONADORA R09-E
        ...
        JPanel v100 = new JPanel(); // DISJUNTOR / TRAFO RF-09
        ...
        v102.setBounds(660, 445, 3, 24); // Seccionadora 89 R08 / Disjuntor
        ...
        JPanel v104 = new JPanel(); // SECCIONADORA 89 R08-E / DISJUNTOR 52 R08
        v104.setBounds(745, 445, 3, 23);
        v104.setBackground(Color.yellow);
        painel.add(v104);

        JPanel v105 = new JPanel(); // SECCIONADORA R08 / SECCIONADORA R08-E
        ...
        JPanel v107 = new JPanel(); // DISJUNTOR / TRAFO RF-08
        v107.setBounds(705, 528, 3, 55);
        v107.setBackground(Color.yellow);
        painel.add(v107);

        // �������������������������������������� CRIA��O DO BOT�O 89 A3
        // ����������������������������������������
        ...
        b10.setBounds(332, 208, 40, 40);
        painel.add(b10);
        // ����������������������������������� CRIA��O DO BOT�O TRAFO LVR-2A
        // ������������������������������������������

        b4 = new JButton(); // BOT�O TRANSFORMADOR LVR-2A
        b4.setIcon(new javax.swing.ImageIcon("LVR2A.jpg"));
        b4.addActionListener(this);
        b4.setBackground(new Color(0, 128, 128));// cor de fundo do bot�o
        b4.setToolTipText("Pressione para comutar o Tap do Transformador LVR-2A");
        ...
        b8.setToolTipText("Pressione para operar o Disjuntor 52 C4");
        ...
        b9.setToolTipText("Pressione para operar a Seccionadora 89 C4-E");
        ...
        b9.setBounds(224, 62, 33, 45);
        painel.add(b9);

        // ��������������������������������������� CRIA��O DO BOT�O BANCO C4
        // ��������������������������������������
        ...
        b14.setToolTipText("Pressione para operar o Disjuntor 52 C3");
        ...
        // ��������������������������������������� CRIA��O DO BOT�O 89 C3-E
        // ���������������������������������������

        b15 = new JButton();
        b15.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg")); // Bot�o 89 C3-E
        b15.addActionListener(this);
        b15.setBackground(new Color(204, 204, 255));// cor de fundo do bot�o
        b15.setToolTipText("Pressione para operar a Seccionadora 89 C3-E");
        ...
        b15.setBounds(74, 61, 33, 45);
        painel.add(b15);

        // ��������������������������������������� CRIA��O DO BOT�O BANCO C3
        // ��������������������������������������

        b16 = new JButton(); // GIF BANCO C3
        ...
        b21.setEnabled(true);
        b21.setToolTipText("Pressione para operar O Disjuntor 52 LVR-2");
        ...
        b29.setEnabled(true);
        b29.setToolTipText("Pressione para operar a Seccionadora 89 RF-7");
        b29.setMnemonic(KeyEvent.VK_B);
        b29.setActionCommand("89P2");// define o nome da acao
        b29.setBounds(850, 62, 33, 45);
        painel.add(b29);
        ...
        b31.setEnabled(true);
        b31.setToolTipText("Pressione para operar a Seccionadora 89 RF-7E");
        b31.setMnemonic(KeyEvent.VK_B);
        b31.setActionCommand("89P2-E");// define o nome da acao
        b31.setBounds(935, 62, 33, 45);
        painel.add(b31);
        ...
        b33.setEnabled(true);
        b33.setToolTipText("Pressione para operar O Disjuntor 52 RF-7");
        b33.setMnemonic(KeyEvent.VK_B);
        b33.setActionCommand("52P2");// define o nome da acao
        b33.setBounds(892, 145, 33, 42);
        painel.add(b33);

        // ����������������������������������� CRIA��O DO BOT�O TRAFO LVR-2
        // ������������������������������������������

        b35 = new JButton(); // BOT�O TRANSFORMADOR LVR-2
        ...
        b35.setToolTipText("Pressione para comutar o Tap do Transformador LVR-2");
        ...
        b36.setForeground(Color.black);// cor do titulo do bot�o
        b36.setEnabled(true);
        b36.setToolTipText("Pressione para operar a Seccionadora 89 A4");
        b36.setMnemonic(KeyEvent.VK_B);
        b36.setActionCommand("89A4");// define o nome da acao
        b36.setBounds(450, 62, 33, 45);
        painel.add(b36);

        // ����������������������������������� CRIA��O DO BOT�O 89 A4-E
        // �����������������������������������������������
        ...
        b38.setEnabled(true);
        b38.setToolTipText("Pressione para operar O Disjuntor 52 A4");
        ...
        b43.setEnabled(true);
        b43.setToolTipText("Pressione para operar a Seccionadora 89 R12");
        ...
        b44.setEnabled(true);
        b44.setToolTipText("Pressione para operar a Seccionadora 89 R12-E");
        b44.setMnemonic(KeyEvent.VK_B);
        b44.setActionCommand("89R5-E");// define o nome da acao
        b44.setBounds(129, 402, 33, 45);
        painel.add(b44);
        ...
        b45.setEnabled(true);
        b45.setToolTipText("Pressione para operar O Disjuntor 52 R12");
        ...
        b48.setEnabled(true);
        b48.setToolTipText("Pressione para operar a Seccionadora 89 R-11");
        ...
        b49.setEnabled(true);
        b49.setToolTipText("Pressione para operar a Seccionadora 89 R11-E");
        ...
        b50.setEnabled(true);
        b50.setToolTipText("Pressione para operar O Disjuntor 52 R11");
        ...
        b51.setEnabled(true);
        b51.setToolTipText("Pressione para operar a Seccionadora 89 R-10");
        ...
        b52.setEnabled(true);
        b52.setToolTipText("Pressione para operar a Seccionadora 89 R10-E");
        ...
        b53.setEnabled(true);
        b53.setToolTipText("Pressione para operar O Disjuntor 52 R10-E");
        ...
        b54.setEnabled(true);
        b54.setToolTipText("Pressione para operar a Seccionadora 89 R-09");
        ...
        b55.setEnabled(true);
        b55.setToolTipText("Pressione para operar a Seccionadora 89 R09-E");
        ...
        b56.setEnabled(true);
        b56.setToolTipText("Pressione para operar O Disjuntor 52 R09");
        ...
        b57.setEnabled(true);
        b57.setToolTipText("Pressione para operar a Seccionadora 89 R-08");
        ...
        b58.setEnabled(true);
        b58.setToolTipText("Pressione para operar a Seccionadora 89 R8-E");
        ...
        b59.setEnabled(true);
        b59.setToolTipText("Pressione para operar O Disjuntor 52 R08");
        ...
        b60.setEnabled(true);
        b60.setToolTipText("Pressione para operar a Seccionadora 89 TA2");
    ...
    {
        if (e.getSource() == b1)// ���������������������� AÇÃO DO BOTÃO DA CS 89 A3 �����������������������
        {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 A3?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89a3().equals("Seccionadora Aberta")) {
                    b1.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89a3();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "89 A3";
                    operacao = "Seccionadora Fechada";
                    manobra = "Bay A3";

                    // BDE.ConectarBD();
                    // BDE.cadastraEventos3(tagequipamento, usuario, data, operacao, manobra);
                    // BDO.ConectarBD();
                ...
                else if (eqp1.seccionadora89a3().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52a3().equals("Disjuntor Aberto")) {
                    b1.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89a3();
            ...
            status1.setText(" 89 A3 " + eqp1.seccionadora89a3());
        }

        // ���������������������������������������� AÇAO DO BOTAO DO DJ 52 A3
        // ��������������������������������������
        if (e.getSource() == b2) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado do Disjuntor 52 A3?",
                    "Disjuntor", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.disjuntor52a3().equals("Disjuntor Aberto")) {
                    eqp1.fecharDisjuntor52a3();
                    b2.setIcon(new javax.swing.ImageIcon("Disjuntor2.jpg"));
                    // valortap.setText (eqp1.getMostrarTapslvr1a());

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "52 A3";
                    ...
                    disjuntor52a3fechado = "Disjuntor 52A3 Fechado";
                    manobrainteligente1.EnerAlbras();
                    // manobrainteligente1.DesenAlbras();

                } else if (eqp1.disjuntor52a3().equals("Disjuntor Fechado")) {
                    b2.setIcon(new javax.swing.ImageIcon("Disjuntor1.jpg"));
                    eqp1.abrirDisjuntor52a3();
                    tap.setText("0 kV");
                    ...
                    disjuntor52a3aberto = "Disjuntor 52A3 Aberto";
                    // DesenAlbras = "DesenergizarAlbras";
                    manobrainteligente1.DesenAlbras();
                    // manobrainteligente1.EnerAlbras();

                    // if (eqp.seccionadora89a3().equals("Seccionadora Aberta") &&
                    // eqp.seccionadora89a3a().equals("Seccionadora Aberta") &&
                    // eqp.disjuntor52a3().equals("Disjuntor Aberto"))
                    // JOptionPane.showMessageDialog(null,"O Disjuntor 52 A3 foi aberto
                    // #TRANSFORMADOR
            ...
            if (eqp1.disjuntor52a3().equals("Disjuntor Fechado")
                    && eqp1.seccionadora89a3().equals("Seccionadora Aberta")
                    || eqp1.disjuntor52a3().equals("Disjuntor Fechado")
                            && eqp1.seccionadora89a3e().equals("Seccionadora Aberta")) {
                status1.setText(" O TRAFO A3 ESTA DESENERGIZADO");
            }
        }

        // ���������������������������������������� A��O DO BOT�O DA CS 89 A3-E
        // ��������������������������������������
        if (e.getSource() == b3) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 A3-E?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89a3e().equals("Seccionadora Aberta")) {
                    b3.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89a3e();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "89 A3E";
                    operacao = "Seccionadora Fechada";
                    manobra = "Bay A3";
                ...
                } else if (eqp1.seccionadora89a3e().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52a3().equals("Disjuntor Aberto")) {
                    b3.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89a3e();
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Logica de Intertravamento nao Satisfeita! \n Seccionadora 89 A3E ABERTA! \n ",
                            "Logica", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("java1.jpg")));
                }
            }
            status1.setText(" 89 A3E " + eqp1.seccionadora89a3e());
        }

        // ������������������������������� A��O DOS BOT�ES DE COMUTA��O DE TAP'S DO
        // LVR-2A ����������������������������
        if (e.getSource() == b4) {
            status1.setText(" O Transformador LVR-2A esta no Tap:" + eqp1.getMostrarTapslvr2a());
            JOptionPane.showMessageDialog(null, "  O Transformador LVR-2A esta no:  " + eqp1.getMostrarTapslvr2a(),
                    "Disjuntor", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("formiga.gif")));
        }
        if (e.getSource() == b5) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja Subir o Tap do Transformador LVR-2A?",
                    "Transformador", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);
            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.getTapslvr2a() == 32)
                    JOptionPane.showMessageDialog(null, "O Transformador LVR-2A esta no Tap Maximo!", "Tap",
                            JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("formiga.gif")));
                eqp1.aumentarTaplvr2a();
                status1.setText(" O Transformador LVR-2A esta no:  " + eqp1.getMostrarTapslvr2a());
                valortap.setText(eqp1.getMostrarTapslvr2a());

                if (eqp1.seccionadora89r7().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r7().equals("Disjuntor Fechado")
                        || eqp1.seccionadora89r7e().equals("Seccionadora Fechada")
                                && eqp1.disjuntor52r7().equals("Disjuntor Fechado")) {
                    tap.setText(eqp1.getValorTaplvr2a());
                }

                String usuario = tfUsuario.getText();
                String data = tfData.getText();
                tagequipamento = "TAP LVR-2A";
        ...
        if (e.getSource() == b6) {
            ...
            int n = JOptionPane.showOptionDialog(this,
                    ...
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);
            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.getTapslvr2a() == 0)
                    JOptionPane.showMessageDialog(null, "O Transformador LVR-2A esta no Tap Minimo!", "Tap",
                            JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("formiga.gif")));
                eqp1.diminuirTaplvr2a();
                status1.setText(" O Transformador LVR-2A esta no:  " + eqp1.getMostrarTapslvr2a());
                valortap.setText(eqp1.getMostrarTapslvr2a());
                if (eqp1.seccionadora89r7().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r7().equals("Disjuntor Fechado")
        ...
        if (e.getSource() == b7)// ���������������������� A��O DO BOT�O DA CS 89 C4
                                // ��������������������������������
        {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 C4?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89c4().equals("Seccionadora Aberta")) {
                    b7.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89c4();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "89 C4";
                    operacao = "Seccionadora Fechada";
                    manobra = "Bay C4";
                    ...
                    seccionadora89c4fechada = "Seccionadora 89C4 Fechada";
                    manobrainteligente1.TransfMTRMT2();
                ...
                else if (eqp1.seccionadora89c4().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52c4().equals("Disjuntor Aberto")) {
                    b7.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89c4();
                    ...
                    seccionadora89c4aberta = "Seccionadora 89C4 Aberta";
                    manobrainteligente1.TransfMT2MTR();
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Logica de Intertravamento nao Satisfeita! \n DISJUNTOR 52 C4 FECHADO! \n",
                            "Logica", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("java1.jpg")));
                }
            }
            status1.setText(" 89 C4 " + eqp1.seccionadora89c4());
        }

        // ���������������������������������������� A��O DO BOT�O DO DJ 52 C4
        // ��������������������������������������
        if (e.getSource() == b8) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado do Disjuntor 52 C4?",
                    "Disjuntor", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.disjuntor52c4().equals("Disjuntor Aberto")) {
                    eqp1.fecharDisjuntor52c4();
                    b8.setIcon(new javax.swing.ImageIcon("Disjuntor2.jpg"));

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "52 C4";
                    operacao = "Disjuntor Fechado";
                    manobra = "Bay C4";
                    ...
                    disjuntor52c4fechado = "Disjuntor 52C4 Fechado";
                    manobrainteligente1.TransfMT2MTR();
                    manobrainteligente1.TransfMTRMT2();
                    manobrainteligente1.NormRed2();

                } else if (eqp1.disjuntor52c4().equals("Disjuntor Fechado")) {
                    b8.setIcon(new javax.swing.ImageIcon("Disjuntor1.jpg"));
                    eqp1.abrirDisjuntor52c4();
                    ...
                    disjuntor52c4aberto = "Disjuntor 52C4 Aberto";
                    manobrainteligente1.TransfMT2MTR();
                    manobrainteligente1.TransfMTRMT2();
                    manobrainteligente1.DeslProgRed2();
            ...
            if (eqp1.disjuntor52c4().equals("Disjuntor Fechado")
                    && eqp1.seccionadora89c4().equals("Seccionadora Aberta")
                    || eqp1.disjuntor52c4().equals("Disjuntor Fechado")
                            && eqp1.seccionadora89c4e().equals("Seccionadora Aberta")) {
                status1.setText(" O BANCO C4 ESTA DESENERGIZADO");
            }
        }

        // ���������������������������������������� A��O DO BOT�O DA CS 89 C4-E
        // ��������������������������������������
        if (e.getSource() == b9) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 C4-E ?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89c4e().equals("Seccionadora Aberta")) {
                    b9.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89c4e();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "89 C4E";
                    operacao = "Seccionadora Fechada";
                    manobra = "Bay C4";
                    ...
                    seccionadora89c4efechada = "Seccionadora 89C4E Fechada";
                    manobrainteligente1.TransfMT2MTR();

                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 MTR-B foi Fechada com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                } else if (eqp1.seccionadora89c4e().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52c4().equals("Disjuntor Aberto")) {
                    b9.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89c4e();
                    ...
                    seccionadora89c4eaberta = "Seccionadora 89C4E Aberta";
                    manobrainteligente1.TransfMTRMT2();

                    // JOptionPane.showMessageDialog(null,"A Seccionadora esta 89 C4-E foi Aberta
                    // com Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                } else {
                    JOptionPane.showMessageDialog(null,
            ...
            status1.setText(" 89 C4-E " + eqp1.seccionadora89c4e());
        }

        // �������������������������������������� A��O DO BOT�O DA CS 89 C3
        // ��������������������������������������
        if (e.getSource() == b13) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 C3?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89c3().equals("Seccionadora Aberta")) {
                    b13.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89c3();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "89 C3";
                    operacao = "Seccionadora Fechada";
                    manobra = "Bay C3";
                    ...
                    seccionadora89c3fechada = "Seccionadora 89C3 Fechada";
                    manobrainteligente1.TransfMTRMT2();
                ...
                else if (eqp1.seccionadora89c3().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52c3().equals("Disjuntor Aberto")) {
                    b13.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89c3();
                    ...
                    seccionadora89c3aberta = "Seccionadora 89C3 Aberta";
                    manobrainteligente1.TransfMT2MTR();

                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 C3 foi Aberta com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                } else {
                    JOptionPane.showMessageDialog(null,
                            "Logica de Intertravamento nao Satisfeita! \n DISJUNTOR 52 C3 FECHADO! \n ",
                            "Logica", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("java1.jpg")));
                }
            }
            status1.setText(" 89 C3 " + eqp1.seccionadora89c3());
        }

        // ������������������������������������ A��O DO BOT�O DO DISJUNTOR 52 C3
        // ����������������������������������
        if (e.getSource() == b14) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado do Disjuntor 52 C3?",
                    "Disjuntor", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.disjuntor52c3().equals("Disjuntor Aberto")) {
                    b14.setIcon(new javax.swing.ImageIcon("Disjuntor2.jpg"));
                    eqp1.fecharDisjuntor52c3();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "52 C3";
                    operacao = "Disjuntor Fechado";
                    manobra = "Bay C3";
                    ...
                    disjuntor52c3fechado = "Disjuntor 52C3 Fechado";
                    manobrainteligente1.TransfMT2MTR();
                    manobrainteligente1.TransfMTRMT2();
                    manobrainteligente1.NormRed2();

                } else if (eqp1.disjuntor52c3().equals("Disjuntor Fechado")) {
                    b14.setIcon(new javax.swing.ImageIcon("Disjuntor1.jpg"));
                    eqp1.abrirDisjuntor52c3();
                    ...
                    disjuntor52c3aberto = "Disjuntor 52C3 Aberto";
                    manobrainteligente1.TransfMT2MTR();
                    manobrainteligente1.TransfMTRMT2();
                    manobrainteligente1.DeslProgRed2();
            ...
            if (eqp1.disjuntor52c3().equals("Disjuntor Fechado")
                    && eqp1.seccionadora89c3().equals("Seccionadora Aberta")
                    && eqp1.disjuntor52c3().equals("Disjuntor Fechado")
                    && eqp1.seccionadora89c3e().equals("Seccionadora Aberta")) {
                status1.setText(" O BANCO C3 ESTA DESENERGIZADO");
            }
        }

        // ��������������������������������������� A��O DO BOT�O DA CS 89 C3-E
        // �������������������������������������
        if (e.getSource() == b15) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 C3-E?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89c3e().equals("Seccionadora Aberta")) {
                    b15.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89c3e();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "89 C3E";
                    operacao = "Seccionadora Fechada";
                    manobra = "Bay C3";
                    ...
                    seccionadora89c3efechada = "Seccionadora 89C3E Fechada";
                    manobrainteligente1.TransfMT2MTR();
                ...
                } else if (eqp1.seccionadora89c3e().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52c3().equals("Disjuntor Aberto")) {
                    b15.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89c3e();
                    ...
                    seccionadora89c3eaberta = "Seccionadora 89C3E Aberta";
                    manobrainteligente1.TransfMTRMT2();

                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 C3-E foi Aberta
                    // com Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));;
                } else {
                    JOptionPane.showMessageDialog(null,
            ...
            status1.setText(" 89 C3-E " + eqp1.seccionadora89c3e());
        }
        ...
        if (e.getSource() == b19) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 LVR-2?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89lvr2().equals("Seccionadora Aberta")) {
                    b19.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89lvr2();
                ...
                else if (eqp1.seccionadora89lvr2().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52lvr2().equals("Disjuntor Aberto")) {
                    b19.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89lvr2();
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Logica de Intertravamento nao Satisfeita! \n DISJUNTOR 52 LVR-2 FECHADO! \n ",
                            "Logica", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("java1.jpg")));
                }
            }
            status1.setText(" 89 LVR-2 " + eqp1.seccionadora89lvr2());
        }
        ...
        if (e.getSource() == b20) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 LVR-2E?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89lvr2e().equals("Seccionadora Aberta")) {
                    b20.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89lvr2e();
                ...
                } else if (eqp1.seccionadora89lvr2e().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52lvr2().equals("Disjuntor Aberto")) {
                    b20.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89lvr2e();
            ...
            status1.setText(" 89 LVR-2E " + eqp1.seccionadora89lvr2e());
        }

        // ################################################# AC�O DO BOT�O DO 52 LVR-2
        // ##############################################################
        if (e.getSource() == b21) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado do Disjuntor 52 LVR-2?",
                    "Disjuntor", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.disjuntor52lvr2().equals("Disjuntor Aberto")) {
                    b21.setIcon(new javax.swing.ImageIcon("Disjuntor2.jpg"));
                    eqp1.fecharDisjuntor52lvr2();
                    // valortap1.setText (eqp1.getMostrarTapslvr1());

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "52 LVR-2";
                    operacao = "Disjuntor Fechado";
                    manobra = "Bay LVR-2";

                    // BDE.ConectarBD();
                    // BDE.cadastraEventos3(tagequipamento, usuario, data, operacao, manobra);
                    disjuntor52lvr2fechado = "Disjuntor 52LVR2 Fechado";
                    manobrainteligente1.NormRed2();
                }

                else if (eqp1.disjuntor52lvr2().equals("Disjuntor Fechado")) {
                    b21.setIcon(new javax.swing.ImageIcon("Disjuntor1.jpg"));
                    eqp1.abrirDisjuntor52lvr2();
                    tap1.setText("0 kV");
                    ...
                    disjuntor52lvr2aberto = "Disjuntor 52LVR2 Aberto";
                    manobrainteligente1.DeslProgRed2();
                    // String data = tfData.getText ();
                }
            }

            if (eqp1.disjuntor52lvr2().equals("Disjuntor Fechado")
                    && eqp1.seccionadora89lvr2().equals("Seccionadora Aberta")
                    || eqp1.disjuntor52lvr2().equals("Disjuntor Fechado")
                            && eqp1.seccionadora89lvr2e().equals("Seccionadora Aberta")) {
        ...
        // LVR-2 ����������������������������
        if (e.getSource() == b35) {
            status1.setText(" O Transformador LVR-2 esta no Tap:" + eqp1.getMostrarTapslvr2());
            JOptionPane.showMessageDialog(null, "  O Transformador LVR-2 esta no:  " + eqp1.getMostrarTapslvr2(),
                    "Disjuntor", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("formiga.gif")));
        }
        if (e.getSource() == b22) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja Subir o Tap do Transformador LVR-2?",
                    "Transformador", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);
            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.getTapslvr2() == 32)
                    JOptionPane.showMessageDialog(null, "O Transformador LVR-2 esta no Tap Maximo!", "Tap",
                            JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("formiga.gif")));
                eqp1.aumentarTaplvr2();
                status1.setText(" O Transformador LVR-2 esta no:  " + eqp1.getMostrarTapslvr2());
                valortap1.setText(eqp1.getMostrarTapslvr2());

                if (eqp1.seccionadora89lvr2().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52lvr2().equals("Disjuntor Fechado")
                        || eqp1.seccionadora89lvr2e().equals("Seccionadora Fechada")
                                && eqp1.disjuntor52lvr2().equals("Disjuntor Fechado")) {
                    tap1.setText(eqp1.getValorTaplvr2());
                }

                String usuario = tfUsuario.getText();
                String data = tfData.getText();
                tagequipamento = "TAP LVR-2";
                operacao = "Tap Elevado";
                manobra = "Bay LVR-2";
        ...
        if (e.getSource() == b23) {
            ...
            int n = JOptionPane.showOptionDialog(this,
                    ...
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);
            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.getTapslvr2() == 0)
                    JOptionPane.showMessageDialog(null, "O Transformador LVR-2 esta no Tap Minimo!", "Tap",
                            JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("formiga.gif")));
                eqp1.diminuirTaplvr2();
                status1.setText(" O Transformador LVR-2 esta no:  " + eqp1.getMostrarTapslvr2());
                valortap1.setText(eqp1.getMostrarTapslvr2());
                if (eqp1.seccionadora89lvr2().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52lvr2().equals("Disjuntor Fechado")
        ...
        // #################################################### BOT�O DE AC�O DA CS 89P3
        // ##########################################################

        if (e.getSource() == b24) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 P3?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89p3().equals("Seccionadora Aberta")) {
                    b24.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89p3();
                    ...
                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "89 P3";
                    operacao = "Seccionadora Fechada";
                    manobra = "Bay P3";

                    // BDE.ConectarBD();
                    // BDE.cadastraEventos3(tagequipamento, usuario, data, operacao, manobra);
                    seccionadora89p3fechada = "Seccionadora 89P3 Fechada";
                    manobrainteligente1.TransfMTRMT2();
                }

                else if (eqp1.seccionadora89p3().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52p3().equals("Disjuntor Aberto")) {
                    b24.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89p3();
                    ...
                    // BDE.ConectarBD();
                    // BDE.cadastraEventos3(tagequipamento, usuario, data, operacao, manobra);
                    seccionadora89p3aberta = "Seccionadora 89P3 Aberta";
                    manobrainteligente1.PrepAlbras();
                    manobrainteligente1.TransfMT2MTR();
                } else {
                    JOptionPane.showMessageDialog(null,
                            "Logica de Intertravamento nao Satisfeita! \n DISJUNTOR 52 P3 FECHADO \n ",
                            "Logica", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("java1.jpg")));
                }
            }
            status1.setText(" 89 P3 " + eqp1.seccionadora89p3());
        }
        ...
        if (e.getSource() == b25) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 P3-E?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89p3e().equals("Seccionadora Aberta")) {
                    b25.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89p3e();
                    ...
                    seccionadora89p3efechada = "Seccionadora 89P3E Fechada";
                    manobrainteligente1.PrepAlbras();
                    manobrainteligente1.TransfMT2MTR();

                } else if (eqp1.seccionadora89p3e().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52p3().equals("Disjuntor Aberto")) {
                    b25.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89p3e();

                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 P3E foi Aberta
                    // com Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));;
                    ...
                    // BDE.cadastraEventos3(tagequipamento, usuario, data, operacao, manobra)
                    ;
                    seccionadora89p3eaberta = "Seccionadora 89P3E Aberta";
                    manobrainteligente1.TransfMTRMT2();
            ...
            status1.setText(" 89 P3-E " + eqp1.seccionadora89p3e());
        }

        // ################################################# AC�O DO BOT�O DO 52 P3
        // ##############################################################
        if (e.getSource() == b26) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado do Disjuntor 52 P3?",
                    "Disjuntor", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.disjuntor52p3().equals("Disjuntor Aberto")) {
                    b26.setIcon(new javax.swing.ImageIcon("Disjuntor2.jpg"));
                    eqp1.fecharDisjuntor52p3();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "52 P3";
                    operacao = "Disjuntor Fechado";
                    manobra = "Bay P3";
                    ...
                    disjuntor52p3fechado = "Disjuntor 52P3 Fechado";
                    manobrainteligente1.EnerAlbras();
                    // manobrainteligente1.DesenAlbras();
                    manobrainteligente1.TransfMT2MTR();
                    manobrainteligente1.TransfMTRMT2();
                ...
                } else if (eqp1.disjuntor52p3().equals("Disjuntor Fechado")) {
                    b26.setIcon(new javax.swing.ImageIcon("Disjuntor1.jpg"));
                    eqp1.abrirDisjuntor52p3();
                    ...
                    disjuntor52p3aberto = "Disjuntor 52P3 Aberto";
                    manobrainteligente1.DesenAlbras();
                    // manobrainteligente1.EnerAlbras();
                    manobrainteligente1.TransfMT2MTR();
                    manobrainteligente1.TransfMTRMT2();
            ...
            if (eqp1.disjuntor52p3().equals("Disjuntor Fechado")
                    && eqp1.seccionadora89p3().equals("Seccionadora Aberta")
                    || eqp1.disjuntor52p3().equals("Disjuntor Fechado")
                            && eqp1.seccionadora89p3e().equals("Seccionadora Aberta")) {
                status1.setText("A PLANTA ESTA DESENERGIZADA! ");
            }
        }

        // ����������������������������������������� A��O DO BOT�O DA CS 89 R7
        // ��������������������������������������
        if (e.getSource() == b29) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 RF-7?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89r7().equals("Seccionadora Aberta")) {
                    b29.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89r7();
                ...
                } else if (eqp1.seccionadora89r7().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r7().equals("Disjuntor Aberto")) {
                    b29.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89r7();

                    // JOptionPane.showMessageDialog(null,"A Seccionadora esta 89 R7 foi Aberta com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));;
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Logica de Intertravamento nao Satisfeita! \n DISJUNTOR 52 R7 FECHADO \n ",
                            "Logica", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("java1.jpg")));
                }
            }
            status1.setText(" CS 89 R7 " + eqp1.seccionadora89r7());
        }

        // ������������������������������������ A��O DO BOT�O DA SECCIONADORA 89 R7-E
        // �������������������������������
        if (e.getSource() == b31) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 R7-E?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89r7e().equals("Seccionadora Aberta")) {
                    b31.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89r7e();
                ...
                else if (eqp1.seccionadora89r7e().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r7().equals("Disjuntor Aberto")) {
                    b31.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89r7e();
            ...
            status1.setText(" 89 R7-E " + eqp1.seccionadora89r7e());
        }

        // ################################################# AC�O DO BOT�O DO 52 R7
        // ##############################################################
        if (e.getSource() == b33) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado do Disjuntor 52 R7?",
                    "Disjuntor", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.disjuntor52r7().equals("Disjuntor Aberto")) {
                    b33.setIcon(new javax.swing.ImageIcon("Disjuntor2.jpg"));
                    eqp1.fecharDisjuntor52r7();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "52 R7";
                    operacao = "Disjuntor Fechado";
                    manobra = "Bay RF-7";

                    // BDE.ConectarBD();
                    // BDE.cadastraEventos3(tagequipamento, usuario, data, operacao, manobra);
                    disjuntor52r7fechado = "Disjuntor 52R7 Fechado";
                    manobrainteligente1.NormRed2();

                } else if (eqp1.disjuntor52r7().equals("Disjuntor Fechado")) {
                    b33.setIcon(new javax.swing.ImageIcon("Disjuntor1.jpg"));
                    eqp1.abrirDisjuntor52r7();
                    ...
                    disjuntor52r7aberto = "Disjuntor 52R7 Aberto";
                    manobrainteligente1.DeslProgRed2();
                }
            }
            if (eqp1.disjuntor52r7().equals("Disjuntor Fechado")
                    && eqp1.seccionadora89r7().equals("Seccionadora Aberta")
                    || eqp1.disjuntor52r7().equals("Disjuntor Fechado")
                            && eqp1.seccionadora89r7e().equals("Seccionadora Aberta")) {
                status1.setText("O RETIFICADOR ESTA DESENERGIZADO! ");
            }
        }
        // ������������������������������������������������� A��O DO BOT�O DA CS 89 A4
        // ���������������������������������������������������
        if (e.getSource() == b36) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 A4?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89a4().equals("Seccionadora Aberta")) {
                    b36.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89a4();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "89 A4";
                    operacao = "Seccionadora Fechada";
                    manobra = "Bay A4";
                ...
                else if (eqp1.seccionadora89a4().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52a4().equals("Disjuntor Aberto")) {
                    b36.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89a4();
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Logica de Intertravamento nao Satisfeita! \n DISJUNTOR 52 A4 FECHADO! \n",
                            "Logica", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("java1.jpg")));
                }
            }
            status1.setText(" 89 A4 " + eqp1.seccionadora89a4());
        }

        // ���������������������������������������� A��O DO BOT�O DA CS 89 A4-E
        // ��������������������������������������
        if (e.getSource() == b37) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 A4-E?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89a4e().equals("Seccionadora Aberta")) {
                    b37.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89a4e();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "89 A4E";
                    operacao = "Seccionadora Fechada";
                    manobra = "Bay A4";
                    ...
                    seccionadora89a4efechada = "Seccionadora 89A4E Fechada";
                    manobrainteligente1.PrepAlbras();

                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 MT1-B foi Fechada com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                } else if (eqp1.seccionadora89a4e().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52a4().equals("Disjuntor Aberto")) {
                    b37.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89a4e();
                    ...
                    seccionadora89a4eaberta = "Seccionadora 89A4E Aberta";
            ...
            status1.setText(" 89 A4-E " + eqp1.seccionadora89a4e());
        }
        // ������������������������������������������������� A��O DO BOT�O DO DJ 52 A4
        // ����������������������������������������������������
        if (e.getSource() == b38) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado do Disjuntor 52 A4?",
                    "Disjuntor", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.disjuntor52a4().equals("Disjuntor Aberto")) {
                    eqp1.fecharDisjuntor52a4();
                    b38.setIcon(new javax.swing.ImageIcon("Disjuntor2.jpg"));
                    // valortap.setText (eqp1.getMostrarTapslvr1a());

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "52 A4";
                    operacao = "Disjuntor Fechado";
                    manobra = "Bay A4";
                    ...
                    disjuntor52a4fechado = "Disjuntor 52A4 Fechado";
                    manobrainteligente1.EnerAlbras();

                } else if (eqp1.disjuntor52a4().equals("Disjuntor Fechado")) {
                    b38.setIcon(new javax.swing.ImageIcon("Disjuntor1.jpg"));
                    eqp1.abrirDisjuntor52a4();
                    tap.setText("0 kV");
                    ...
                    disjuntor52a4aberto = "Disjuntor 52A4 Aberto";
                    manobrainteligente1.DesenAlbras();

                    // if (eqp.seccionadora89mt1a().equals("Seccionadora Aberta") &&
                    // eqp.seccionadora89mt1b().equals("Seccionadora Aberta") &&
                    // eqp.disjuntor52bt().equals("Disjuntor Aberto"))
                    // JOptionPane.showMessageDialog(null,"O Disjuntor 52 A4 foi aberto
                    // #TRANSFORMADOR
                    // DESENERGIZADO!#","Disjuntor",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                } else {
            ...
            if (eqp1.disjuntor52a4().equals("Disjuntor Fechado")
                    && eqp1.seccionadora89a4().equals("Seccionadora Aberta")
                    || eqp1.disjuntor52a4().equals("Disjuntor Fechado")
                            && eqp1.seccionadora89a4e().equals("Seccionadora Aberta")) {
                status1.setText(" O TRAFO A4 ESTA DESENERGIZADO");
            }
        }
        ...
        if (e.getSource() == b43) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 RF-12?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89r12().equals("Seccionadora Aberta")) {
                    b43.setIcon(new javax.swing.ImageIcon("Chave1.4.jpg"));
                    eqp1.fecharSeccionadora89r12();
                ...
                } else if (eqp1.seccionadora89r12().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r12().equals("Disjuntor Aberto")) {
                    b43.setIcon(new javax.swing.ImageIcon("Chave1.3.jpg"));
                    eqp1.abrirSeccionadora89r12();

                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 R12 foi Aberta com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Logica de Intertravamento nao Satisfeita! \n DISJUNTOR 52 R12 FECHADO \n ",
                            "Logica", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("java1.jpg")));
                }
            }
            status1.setText(" 89 R12 " + eqp1.seccionadora89r12());
        }
        ...
        if (e.getSource() == b44) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 RF-12E?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89r12e().equals("Seccionadora Aberta")) {
                    b44.setIcon(new javax.swing.ImageIcon("Chave1.4.jpg"));
                    eqp1.fecharSeccionadora89r12e();
                ...
                } else if (eqp1.seccionadora89r12e().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r12().equals("Disjuntor Aberto")) {
                    b44.setIcon(new javax.swing.ImageIcon("Chave1.3.jpg"));
                    eqp1.abrirSeccionadora89r12e();
            ...
            status1.setText(" 89 R12E " + eqp1.seccionadora89r12e());
        }

        // ################################################# AC�O DO BOT�O DO 52 R12
        // ##############################################################
        if (e.getSource() == b45) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado do Disjuntor 52 R12?",
                    "Disjuntor", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.disjuntor52r12().equals("Disjuntor Aberto")) {
                    b45.setIcon(new javax.swing.ImageIcon("Disjuntor2.jpg"));
                    eqp1.fecharDisjuntor52r12();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "52 RF-12";
                    operacao = "Disjuntor Fechado";
                    manobra = "Bay RF-12";
                ...
                } else if (eqp1.disjuntor52r12().equals("Disjuntor Fechado")) {
                    b45.setIcon(new javax.swing.ImageIcon("Disjuntor1.jpg"));
                    eqp1.abrirDisjuntor52r12();
            ...
            if (eqp1.disjuntor52r12().equals("Disjuntor Fechado")
        ...
        if (e.getSource() == b48) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 RF-11?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89r11().equals("Seccionadora Aberta")) {
                ...
                } else if (eqp1.seccionadora89r11().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r11().equals("Disjuntor Aberto")) {
                    b48.setIcon(new javax.swing.ImageIcon("Chave1.3.jpg"));
                    eqp1.abrirSeccionadora89r11();
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Logica de Intertravamento nao Satisfeita! \n DISJUNTOR 52 R11 FECHADO \n ",
                            "Logica", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("java1.jpg")));
                }
            }
            status1.setText(" 89 R11 " + eqp1.seccionadora89r11());
        }
        ...
        if (e.getSource() == b49) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 RF-11E?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89r11e().equals("Seccionadora Aberta")) {
                    b49.setIcon(new javax.swing.ImageIcon("Chave1.4.jpg"));
                    eqp1.fecharSeccionadora89r11e();
                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 BTB foi Fechada com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                ...
                } else if (eqp1.seccionadora89r11e().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r11().equals("Disjuntor Aberto")) {
                    b49.setIcon(new javax.swing.ImageIcon("Chave1.3.jpg"));
                    eqp1.abrirSeccionadora89r11e();
            ...
            status1.setText(" 89 R11-E " + eqp1.seccionadora89r11e());
        }

        // ################################################# AC�O DO BOT�O DO 52 R11
        // ##############################################################
        if (e.getSource() == b50) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado do Disjuntor 52 R11?",
                    "Disjuntor", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.disjuntor52r11().equals("Disjuntor Aberto")) {
                    b50.setIcon(new javax.swing.ImageIcon("Disjuntor2.jpg"));
                    eqp1.fecharDisjuntor52r11();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "52 RF-11";
                    operacao = "Disjuntor Fechado";
                    manobra = "Bay RF-11";
                ...
                } else if (eqp1.disjuntor52r11().equals("Disjuntor Fechado")) {
                    b50.setIcon(new javax.swing.ImageIcon("Disjuntor1.jpg"));
                    eqp1.abrirDisjuntor52r11();
            ...
            if (eqp1.disjuntor52r11().equals("Disjuntor Fechado")
                    && eqp1.seccionadora89r11().equals("Seccionadora Aberta")
                    || eqp1.disjuntor52r11().equals("Disjuntor Fechado")
                            && eqp1.seccionadora89r11e().equals("Seccionadora Aberta")) {
                status1.setText("O RETIFICADOR ESTA DESENERGIZADO! ");
            }
        }
        ...
        if (e.getSource() == b51) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 RF-10?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89r10().equals("Seccionadora Aberta")) {
                    b51.setIcon(new javax.swing.ImageIcon("Chave1.4.jpg"));
                    eqp1.fecharSeccionadora89r10();
                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 BTB foi Fechada com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                    ...
                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "89 RF-10";
                    operacao = "Seccionadora Fechada";
                    manobra = "Bay RF-10";

                    // BDE.cadastraEventos3(tagequipamento, usuario, data, operacao, manobra);

                } else if (eqp1.seccionadora89r10().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r10().equals("Disjuntor Aberto")) {
                    b51.setIcon(new javax.swing.ImageIcon("Chave1.3.jpg"));
                    eqp1.abrirSeccionadora89r10();
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Logica de Intertravamento nao Satisfeita! \n DISJUNTOR 52 R10 FECHADO \n ",
                            "Logica", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("java1.jpg")));
                }
            }
            status1.setText(" 89 R10 " + eqp1.seccionadora89r10());
        }
        ...
        if (e.getSource() == b52) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 RF-10E?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89r10e().equals("Seccionadora Aberta")) {
                    b52.setIcon(new javax.swing.ImageIcon("Chave1.4.jpg"));
                    eqp1.fecharSeccionadora89r10e();
                ...
                } else if (eqp1.seccionadora89r10e().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r10().equals("Disjuntor Aberto")) {
                    b52.setIcon(new javax.swing.ImageIcon("Chave1.3.jpg"));
                    eqp1.abrirSeccionadora89r10e();
                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 RF-10E foi Aberta com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
            ...
            status1.setText(" 89 R10E " + eqp1.seccionadora89r10e());
        }

        // ################################################# AC�O DO BOT�O DO 52 R10
        // ##############################################################
        if (e.getSource() == b53) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado do Disjuntor 52 R10?",
                    "Disjuntor", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.disjuntor52r10().equals("Disjuntor Aberto")) {
                    b53.setIcon(new javax.swing.ImageIcon("Disjuntor2.jpg"));
                    eqp1.fecharDisjuntor52r10();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "52 RF-10";
                    operacao = "Disjuntor Fechado";
                    manobra = "Bay RF-10";

                    // BDE.ConectarBD();
                    // BDE.cadastraEventos3(tagequipamento, usuario, data, operacao, manobra);
                } else if (eqp1.disjuntor52r10().equals("Disjuntor Fechado")) {
                    b53.setIcon(new javax.swing.ImageIcon("Disjuntor1.jpg"));
                    eqp1.abrirDisjuntor52r10();
            ...
            if (eqp1.disjuntor52r10().equals("Disjuntor Fechado")
                    && eqp1.seccionadora89r10().equals("Seccionadora Aberta")
                    || eqp1.disjuntor52r10().equals("Disjuntor Fechado")
                            && eqp1.seccionadora89r10e().equals("Seccionadora Aberta")) {
                status1.setText("O RETIFICADOR ESTA DESENERGIZADO! ");
            }
        }
        ...
        // RF-09 #########################################################
        if (e.getSource() == b54) {
            Object[] options = { "Sim", "Neo", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 RF-09?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89r9().equals("Seccionadora Aberta")) {
                    b54.setIcon(new javax.swing.ImageIcon("Chave1.4.jpg"));
                    eqp1.fecharSeccionadora89r9();
                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 BTB foi Fechada com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                    ...
                    seccionadora89r9fechada = "Seccionadora 89R9 Fechada";
                    manobrainteligente1.TransfMTRMT2();
                } else if (eqp1.seccionadora89r9().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r9().equals("Disjuntor Aberto")) {
                    b54.setIcon(new javax.swing.ImageIcon("Chave1.3.jpg"));
                    eqp1.abrirSeccionadora89r9();
                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 BTB foi Aberta com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                    ...
                    seccionadora89r9aberta = "Seccionadora 89R9 Aberta";
                    manobrainteligente1.TransfMT2MTR();
                } else {
                    JOptionPane.showMessageDialog(null,
                            "Logica de Intertravamento nao Satisfeita! \n DISJUNTOR 52 R-09 FECHADO \n ",
                            "Logica", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("java1.jpg")));
                }
            }
            status1.setText(" 89 R-09 " + eqp1.seccionadora89r9());
        }
        ...
        if (e.getSource() == b55) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 RF-09E?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89r9e().equals("Seccionadora Aberta")) {
                    b55.setIcon(new javax.swing.ImageIcon("Chave1.4.jpg"));
                    eqp1.fecharSeccionadora89r9e();
                    ...
                    seccionadora89r9efechada = "Seccionadora 89R9E Fechada";
                    manobrainteligente1.TransfMT2MTR();
                } else if (eqp1.seccionadora89r9e().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r9().equals("Disjuntor Aberto")) {
                    b55.setIcon(new javax.swing.ImageIcon("Chave1.3.jpg"));
                    eqp1.abrirSeccionadora89r9e();
                    ...
                    seccionadora89r9eaberta = "Seccionadora 89R9E Aberta";
                    manobrainteligente1.TransfMTRMT2();
            ...
            status1.setText(" 89 R09-E " + eqp1.seccionadora89r9e());
        }

        // ################################################# AC�O DO BOT�O DO 52 R09
        // ##############################################################
        if (e.getSource() == b56) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado do Disjuntor 52 R-09?",
                    "Disjuntor", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.disjuntor52r9().equals("Disjuntor Aberto")) {
                    b56.setIcon(new javax.swing.ImageIcon("Disjuntor2.jpg"));
                    eqp1.fecharDisjuntor52r9();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "52 RF-09";
                    operacao = "Disjuntor Fechado";
                    manobra = "Bay RF-09";

                    // BDE.ConectarBD();
                    // BDE.cadastraEventos3(tagequipamento, usuario, data, operacao, manobra);
                    disjuntor52r9fechado = "Disjuntor 52R9 Fechado";
                    manobrainteligente1.TransfMT2MTR();
                    manobrainteligente1.TransfMTRMT2();

                } else if (eqp1.disjuntor52r9().equals("Disjuntor Fechado")) {
                    b56.setIcon(new javax.swing.ImageIcon("Disjuntor1.jpg"));
                    eqp1.abrirDisjuntor52r9();
                    ...
                    disjuntor52r9aberto = "Disjuntor 52R9 Aberto";
                    manobrainteligente1.TransfMT2MTR();
                    manobrainteligente1.TransfMTRMT2();
                }
            }
            if (eqp1.disjuntor52r9().equals("Disjuntor Fechado")
                    && eqp1.seccionadora89r9().equals("Seccionadora Aberta")
                    || eqp1.disjuntor52r9().equals("Disjuntor Fechado")
                            && eqp1.seccionadora89r9e().equals("Seccionadora Aberta")) {
                status1.setText("O RETIFICADOR ESTA DESENERGIZADO! ");
            }
        }
        ...
        if (e.getSource() == b57) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 RF-08?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89r8().equals("Seccionadora Aberta")) {
                    b57.setIcon(new javax.swing.ImageIcon("Chave1.4.jpg"));
                    eqp1.fecharSeccionadora89r8();
                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 BTB foi Fechada com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                    ...
                    seccionadora89r8fechada = "Seccionadora 89R8 Fechada";
                    manobrainteligente1.TransfMTRMT2();

                } else if (eqp1.seccionadora89r8().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r8().equals("Disjuntor Aberto")) {
                    b57.setIcon(new javax.swing.ImageIcon("Chave1.3.jpg"));
                    eqp1.abrirSeccionadora89r8();
                    // JOptionPane.showMessageDialog(null,"A Seccionadora BTB foi Aberta com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                    ...
                    BDE.ConectarBD();
                    BDE.cadastraEventos3(tagequipamento, usuario, data, operacao, manobra);
                    seccionadora89r8aberta = "Seccionadora 89R8 Aberta";
                    manobrainteligente1.TransfMT2MTR();
                } else {
                    JOptionPane.showMessageDialog(null,
                            "Logica de Intertravamento nao Satisfeita! \n DISJUNTOR 52 R-08 FECHADO \n ",
                            "Logica", JOptionPane.INFORMATION_MESSAGE, (new javax.swing.ImageIcon("java1.jpg")));
                }
            }
            status1.setText(" 89 R-08 " + eqp1.seccionadora89r8());
        }
        ...
        if (e.getSource() == b58) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 RF-08E?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89r8e().equals("Seccionadora Aberta")) {
                    b58.setIcon(new javax.swing.ImageIcon("Chave1.4.jpg"));
                    eqp1.fecharSeccionadora89r8e();
                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 BTB foi Fechada com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                    ...
                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "89 RF-08E";
                    operacao = "Seccionadora Fechada";
                    manobra = "Bay RF-08E";

                    // BDE.ConectarBD();
                    // BDE.cadastraEventos3(tagequipamento, usuario, data, operacao, manobra);
                    seccionadora89r8efechada = "Seccionadora 89R8E Fechada";
                    manobrainteligente1.TransfMT2MTR();

                } else if (eqp1.seccionadora89r8e().equals("Seccionadora Fechada")
                        && eqp1.disjuntor52r8().equals("Disjuntor Aberto")) {
                    b58.setIcon(new javax.swing.ImageIcon("Chave1.3.jpg"));
                    eqp1.abrirSeccionadora89r8e();
                    ...
                    seccionadora89r8eaberta = "Seccionadora 89R8E Aberta";
                    manobrainteligente1.TransfMTRMT2();
                } else {
                    JOptionPane.showMessageDialog(null,
                            "Logica de Intertravamento nao Satisfeita! \n DISJUNTOR 52 R-08 FECHADO \n ",
            ...
            status1.setText(" 89 R-08E " + eqp1.seccionadora89r8e());
        }

        // ################################################# AC�O DO BOT�O DO 52 R08
        // ##############################################################
        if (e.getSource() == b59) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado do Disjuntor 52 R9?",
                    "Disjuntor", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.disjuntor52r8().equals("Disjuntor Aberto")) {
                    b59.setIcon(new javax.swing.ImageIcon("Disjuntor2.jpg"));
                    eqp1.fecharDisjuntor52r8();

                    String usuario = tfUsuario.getText();
                    String data = tfData.getText();
                    tagequipamento = "52 RF-08";
                    operacao = "Disjuntor Fechado";
                    manobra = "Bay RF-08";
                    ...
                    disjuntor52r8fechado = "Disjuntor 52R8 Fechado";
                    manobrainteligente1.TransfMT2MTR();
                    manobrainteligente1.TransfMTRMT2();

                } else if (eqp1.disjuntor52r8().equals("Disjuntor Fechado")) {
                    b59.setIcon(new javax.swing.ImageIcon("Disjuntor1.jpg"));
                    eqp1.abrirDisjuntor52r8();
                    ...
                    disjuntor52r8aberto = "Disjuntor 52R8 Aberto";
                    manobrainteligente1.TransfMT2MTR();
                    manobrainteligente1.TransfMTRMT2();
                }
            }
            if (eqp1.disjuntor52r8().equals("Disjuntor Fechado")
                    && eqp1.seccionadora89r8().equals("Seccionadora Aberta")
                    || eqp1.disjuntor52r8().equals("Disjuntor Fechado")
                            && eqp1.seccionadora89r8e().equals("Seccionadora Aberta")) {
                status1.setText("O RETIFICADOR ESTA DESENERGIZADO! ");
            }
        }
        // ################################################# ACÃO DO BOTÃO DA
        ...
        if (e.getSource() == b60) {
            Object[] options = { "Sim", "Nao", "Cancelar" };
            int n = JOptionPane.showOptionDialog(this,
                    "Voce realmente deseja alterar o estado da Seccionadora 89 TA2?",
                    "Seccionadora", JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, options, options[2]);

            if (n == JOptionPane.YES_OPTION) {
                if (eqp1.seccionadora89ta2().equals("Seccionadora Aberta")) {
                    b60.setIcon(new javax.swing.ImageIcon("Chave1.2.jpg"));
                    eqp1.fecharSeccionadora89ta2();
                    // JOptionPane.showMessageDialog(null,"A Seccionadora 89 BTB foi Fechada com
                    // Sucesso!","Seccionadora",JOptionPane.INFORMATION_MESSAGE,(new
                    // javax.swing.ImageIcon("formiga.gif")));
                ...
                } else if (eqp1.seccionadora89ta2().equals("Seccionadora Fechada")) {
                    b60.setIcon(new javax.swing.ImageIcon("Chave1.1.jpg"));
                    eqp1.abrirSeccionadora89ta2();
            ...
            status1.setText(" 89 TA2 " + eqp1.seccionadora89ta2());
        }
    ...
    // ################# CLASSE DO MENU GERAL DE MANOBRAS ###############
    public class MenuManobrasG extends JFrame implements ActionListener {
        ...
        public MenuManobrasG() // --- Configura��o do Frame
        {
            ...
            bManReduçao.setToolTipText("Pressione para chamar o Menu das Manobras da Redução");
            ...
            bManTransferencia.setActionCommand("Opera��es");// define o nome da acao
        ...
        public MenuManobrasTransf() // --- Configura��o do Frame
        {
            ...
            bTransfMT2MTR.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent evt) {
                    ...
                    status1.setText(
                            "MANOBRA HABILITADA PARA SIMULAÇAO: " + " Manobra para transferir do MT-2 para o MT-R");
                    JOptionPane.showMessageDialog(null,
                ...
                public void actionPerformed(ActionEvent evt) {
                    {
                        ...
                        status1.setText(
                                "MANOBRA HABILITADA PARA SIMULAÇAO: " + " Manobra para Tranferir do MT-R para MT-2");
                        JOptionPane.showMessageDialog(null,
    ...
    // ############ CLASSE DO MENU DAS MANOBRAS DA REDUÇÃO ###########
    public class MenuManobrasReduçao extends JFrame implements ActionListener {
        ...
        public MenuManobrasReduçao() // --- Configura��o do Frame
        {
            ...
            bDesligamentoProgRed2.addActionListener(new ActionListener() // A��o do bot�o Gravar
            {
                public void actionPerformed(ActionEvent evt) {
                    {
                        DeslProgRed2 = "DeslProgRed2";
                        status1.setText("MANOBRA HABILITADA PARA SIMULAÇAO: "
                                + "Manobra para Desligamento da Reduçao 2                                  ");
                        JOptionPane.showMessageDialog(null,
            ...
            bNormalizaçaoRed2.addActionListener(new ActionListener() // A��o do bot�o Gravar
            {
                public void actionPerformed(ActionEvent evt) {
                    {
                        NormRed2 = "NormalizacaoRed2";
                        status1.setText(
                                "MANOBRA HABILITADA PARA SIMULAÇAO: " + " Manobra para Normalizaçao da Reduçao 2");
                        JOptionPane.showMessageDialog(null,
                                "A Manobra para Normalizaçao da Reduçao 2 foi Habilitada com Sucesso!!!");
                    }
                }
            });
            ...
            Comparar.addActionListener(new ActionListener() // A��o do bot�o Gravar
            {
                public void actionPerformed(ActionEvent evt) {
                    ...
                    if (DeslProgRed2.equals("DeslProgRed2")) {
                        mostrar1.setText("                 " + disjuntor52c3aberto);
                        mostrar2.setText("                 " + disjuntor52c4aberto);
                        mostrar3.setText("                 " + disjuntor52r7aberto);
                        mostrar4.setText("               " + disjuntor52lvr2aberto);
                    }
                    ...
                    if (TransfMT2MTR.equals("TransferirMT2MTR")) {
                        mostrar1.setText("            " + disjuntor52c3aberto);
                        mostrar2.setText("            " + disjuntor52c4aberto);
                        mostrar3.setText("            " + disjuntor52r8aberto);
                        mostrar4.setText("         " + seccionadora89r8aberta);
                        mostrar5.setText("       " + seccionadora89r8efechada);
                        mostrar6.setText("           " + disjuntor52r8fechado);
                        mostrar7.setText("           " + disjuntor52r9aberto);
                        mostrar8.setText("        " + seccionadora89r9aberta);
                        mostrar9.setText("      " + seccionadora89r9efechada);
                        mostrar10.setText("          " + disjuntor52r9fechado);
                        mostrar11.setText("           " + disjuntor52p3aberto);
                        mostrar12.setText("        " + seccionadora89c3aberta);
                        mostrar13.setText("      " + seccionadora89c3efechada);
                        mostrar14.setText("        " + seccionadora89c4aberta);
                        mostrar15.setText("      " + seccionadora89c4efechada);
                        mostrar16.setText("          " + disjuntor52c3fechado);
                        mostrar17.setText("          " + disjuntor52c4fechado);
                        mostrar18.setText("        " + seccionadora89p3aberta);
                        mostrar19.setText("      " + seccionadora89p3efechada);
                        mostrar20.setText("          " + disjuntor52p3fechado);
                    }

                    if (TransfMTRMT2.equals("TransferirMTRMT2")) {
                        mostrar1.setText("             " + disjuntor52p3aberto);
                        mostrar2.setText("         " + seccionadora89p3eaberta);
                        mostrar3.setText("         " + seccionadora89p3fechada);
                        mostrar4.setText("             " + disjuntor52c3aberto);
                        mostrar5.setText("             " + disjuntor52c4aberto);
                        mostrar6.setText("             " + disjuntor52r8aberto);
                        mostrar7.setText("         " + seccionadora89r8eaberta);
                        mostrar8.setText("         " + seccionadora89r8fechada);
                        mostrar9.setText("            " + disjuntor52r8fechado);
                        mostrar10.setText("            " + disjuntor52r9aberto);
                        mostrar11.setText("        " + seccionadora89r9eaberta);
                        mostrar12.setText("        " + seccionadora89r9fechada);
                        mostrar13.setText("           " + disjuntor52r9fechado);
                        mostrar14.setText("           " + disjuntor52p3fechado);
                        mostrar15.setText("        " + seccionadora89c3eaberta);
                        mostrar16.setText("        " + seccionadora89c3fechada);
                        mostrar17.setText("        " + seccionadora89c4eaberta);
                        mostrar18.setText("        " + seccionadora89c4fechada);
                        mostrar19.setText("           " + disjuntor52c3fechado);
                        mostrar20.setText("           " + disjuntor52c4fechado);
                    }
                    ...
                    if (DeslProgRed2.equals("DeslProgRed2")) {
                        manobra = " OM para Desligar a Reduçao 2";
                        lbManobra.setText(manobra);
                    }

                    if (NormRed2.equals("NormalizacaoRed2")) {
                        manobra = " OM para Normalizar a Reduçao 2";
                        lbManobra.setText(manobra);
                    }
                    ...
                    if (TransfMTRMT2.equals("TransferirMTRMT2")) {
                        manobra = " OM para Transferir do Traffo MT-R para o MT-2";
                        lbManobra.setText(manobra);
                    }
    ...
    public class ManobraPadrao extends JFrame // implements ActionListener
    {
        ...
        public ManobraPadrao() {
            ...
            projeto = new JLabel(" Manobra Padrao!", projeto.CENTER);
            projeto.setFont(new Font("Arial", 1, 28));
            projeto.setForeground(Color.blue);
            painel.add(projeto);
            ...
            Comparar.addActionListener(new ActionListener() // A��o do bot�o Gravar
            {
                public void actionPerformed(ActionEvent evt) {
                    ...
                    if (DeslProgRed2.equals("DeslProgRed2")) {
                        ...
                        mostrar4.setText("                4. Desligar Disjuntor 52 LVR-2");
                    }
                    ...
                    if (TransfMT2MTR.equals("TransferirMT2MTR")) {
                        mostrar1.setText("     1. Desligar Disjuntor 52 P3 ");
                        mostrar2.setText("     2. Abrir Seccionadora 89 P3 ");
                        mostrar3.setText("  3. Fechar Seccionadora 89 P3-E ");
                        ...
                        mostrar7.setText("    7. Abrir Seccionadora 89 R-8 ");
                        mostrar8.setText("  8. Fechar Seccionadora 89 R-8E ");
                        mostrar9.setText("      9. Fechar Disjuntor 52 R-8 ");
                        mostrar10.setText("     10. Abrir Disjuntor 52 R-9 ");
                        mostrar11.setText("  11. Abrir Seccionadora 89 R-9 ");
                        mostrar12.setText("12. Fechar Seccionadora 89 R-9E ");
                        mostrar13.setText("    13. Fechar Disjuntor 52 R-9 ");
                        mostrar14.setText("     14. Fechar Disjuntor 52 P3 ");
                        mostrar15.setText("   16. Abrir Seccionadora 89 C3 ");
                        mostrar16.setText("17. Fechar Seccionadora 89 C3-E ");
                        mostrar17.setText("   18. Abrir Seccionadora 89 C4 ");
                        mostrar18.setText("19. Fechar Seccionadora 89 C4-E ");
                        mostrar19.setText("     20. Fechar Disjuntor 52 C3 ");
                        mostrar20.setText("     21. Fechar Disjuntor 52 C4 ");
                    }
                    ...
                    if (TransfMTRMT2.equals("TransferirMTRMT2")) {
                        ...
                        mostrar5.setText("        5. Abrir Disjuntor 52 C4 ");
                        mostrar6.setText("       6. Abrir disjuntor 52 R-8 ");
                        mostrar7.setText("    7. Abrir Seccionadora89 R-8E ");
                        mostrar8.setText("  8. Fechar Secccionadora 89 R-8 ");
                        mostrar9.setText("      9. Fechar Disjuntor 52 R-8 ");
                        mostrar10.setText("     10. Abrir Disjuntor 52 R-9 ");
                        mostrar11.setText(" 11. Abrir Seccionadora 89 R-9E ");
                        mostrar12.setText(" 12. Fechar Seccionadora 89 R-9 ");
                        mostrar13.setText("    13. Fechar Disjuntor 52 R-9 ");
                        mostrar14.setText("     14. Fechar Disjuntor 52 P3 ");
                        mostrar15.setText("   16. Abrir Seccionadora 89 C3 ");
                        mostrar16.setText("17. Fechar Seccionadora 89 C3-E ");
                        mostrar17.setText("   18. Abrir Seccionadora 89 C4 ");
                        mostrar18.setText("  19. Fechar Seccionadora 89 C4E");
                        mostrar19.setText("     20. Fechar Disjuntor 52 C3 ");
                        mostrar20.setText("     21. Fechar Disjuntor 52 C4 ");
                    }
    ...
    // ############ CLASSE DA MANOBRAS INTELIGENTE1 ###########
    public class ManobraInteligente1 {
        ...
        public void EnerAlbras() {
            if (EnerAlbras.equals("EnergizarAlbras")) {
                ...
                if (disjuntor52a3fechado.equals("Disjuntor 52A3 Fechado") && passo == 0) {
                    passo = passo + 1;
                    relogio.passo = 10;
                    relogio.rendimento();
                ...
                else if (disjuntor52a4fechado.equals("Disjuntor 52A4 Fechado") && passo == 1) {
                    passo = passo + 1;
                    relogio.passo = 11;
                    relogio.rendimento();
                ...
                } else if (disjuntor52p3fechado.equals("Disjuntor 52P3 Fechado") && passo == 2) {
                    passo = passo + 1;
                    relogio.passo = 20;
                    relogio.rendimento();
        ...
        public void DesenAlbras() {
            if (DesenAlbras.equals("DesenergizarAlbras")) {
                ...
                if (disjuntor52a3aberto.equals("Disjuntor 52A3 Aberto") && passo == 0) {
                    passo = passo + 1;
                    relogio.passo = 10;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null,
                            "Passo 12 realizado com sucesso!!!",
                            "Desenergizar Subestaçao ALBRAS", JOptionPane.INFORMATION_MESSAGE);
                }

                else if (disjuntor52a4aberto.equals("Disjuntor 52A4 Aberto") && passo == 1) {
                    passo = passo + 1;
                    relogio.passo = 11;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null,
                            "Passo 13 realizado com sucesso. Continue no Painel do LVR-3!!!",
                            "Passo para Desenergizar a SE ALBRAS.",
                            JOptionPane.INFORMATION_MESSAGE);

                } else if (disjuntor52p3aberto.equals("Disjuntor 52P3 Aberto") && passo == 2) {
                    passo = passo + 1;
                    relogio.passo = 23;
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Passo 20 realizado com sucesso. Continue no Painel do LVR-3!!!",
                            "Passo para Desenergizar a SE ALBRAS.",
                            JOptionPane.INFORMATION_MESSAGE);

                    // if (passo == 3 && disjuntor52p3aberto.equals("Disjuntor 52P3 Aberto") ||
                    // passo != 23)
                    // JOptionPane.showMessageDialog(null,
                    // "OM para Desenergizar a SE ALBRAS ! Continue no Painel LVR-3 !!!",
                    // "Desenergizar Subestaçao ALBRAS", JOptionPane.INFORMATION_MESSAGE);
        ...
        public void PrepAlbras() {
            if (PrepAlbras.equals("PrepAlbras")) {
                ...
                if (seccionadora89a4eaberta.equals("Seccionadora 89A4E Aberta") && passo == 0) {
                    passo = passo + 1;
                    relogio.passo = 1;
                    relogio.rendimento();
                ...
                else if (seccionadora89p3aberta.equals("Seccionadora 89P3 Aberta") && passo == 1) {
                    passo = passo + 1;
                    relogio.passo = 2;
                    relogio.rendimento();
                ...
                else if (seccionadora89a4efechada.equals("Seccionadora 89A4E Fechada") && passo == 2) {
                    passo = passo + 1;
                    relogio.passo = 2;
                    relogio.rendimento();
                ...
                else if (seccionadora89p3efechada.equals("Seccionadora 89P3E Fechada") && passo == 3) {
                    passo = passo + 1;
                    relogio.passo = 2;
                    relogio.rendimento();
        ...
        public void TransfMT2MTR() {
            if (TransfMT2MTR.equals("TransferirMT2MTR")) {
                relogio.quantpassos = 20;
                if (disjuntor52p3aberto.equals("Disjuntor 52P3 Aberto") && passo == 0) {
                    relogio.zeraOtempo();
                    relogio.iniciaTempo();
                    passo = passo + 1;
                    relogio.setVisible(true);
                    ...
                    JOptionPane.showMessageDialog(null, "Passo 1 realizado com sucesso !!!",
                            "Transferir do MT-2 para MT-R", JOptionPane.INFORMATION_MESSAGE);
                }
                ...
                else if (seccionadora89p3efechada.equals("Seccionadora 89P3E Fechada") && passo == 2) {
                    passo = passo + 1;
                    relogio.passo = 3;
                    relogio.rendimento();
                ...
                else if (disjuntor52c3aberto.equals("Disjuntor 52C3 Aberto") && passo == 3) {
                    passo = passo + 1;
                    relogio.passo = 4;
                    relogio.rendimento();
                ...
                else if (disjuntor52c4aberto.equals("Disjuntor 52C4 Aberto") && passo == 4) {
                    passo = passo + 1;
                    relogio.passo = 5;
                    relogio.rendimento();
                ...
                else if (disjuntor52r8aberto.equals("Disjuntor 52R8 Aberto") && passo == 5) {
                    passo = passo + 1;
                    relogio.passo = 6;
                    relogio.rendimento();
                ...
                else if (seccionadora89r8aberta.equals("Seccionadora 89R8 Aberta") && passo == 6) {
                    passo = passo + 1;
                    relogio.passo = 7;
                    relogio.rendimento();
                ...
                else if (seccionadora89r8efechada.equals("Seccionadora 89R8E Fechada") && passo == 7) {
                    passo = passo + 1;
                    relogio.passo = 8;
                    relogio.rendimento();
                ...
                else if (disjuntor52r8fechado.equals("Disjuntor 52R8 Fechado") && passo == 8) {
                    passo = passo + 1;
                    relogio.passo = 9;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 9 realizado com sucesso !!!",
                ...
                else if (disjuntor52r9aberto.equals("Disjuntor 52R9 Aberto") && passo == 9) {
                    passo = passo + 1;
                    relogio.passo = 10;
                    relogio.rendimento();
                ...
                else if (seccionadora89r9aberta.equals("Seccionadora 89R9 Aberta") && passo == 10) {
                    passo = passo + 1;
                    relogio.passo = 11;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 11 realizado com sucesso !!!",
                            "Transferir do MT-2 para MT-R", JOptionPane.INFORMATION_MESSAGE);
                } else if (seccionadora89r9efechada.equals("Seccionadora 89R9E Fechada") && passo == 11) {
                    passo = passo + 1;
                    relogio.passo = 12;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 12 realizado com sucesso !!!",
                            "Transferir do MT-2 para MT-R", JOptionPane.INFORMATION_MESSAGE);
                } else if (disjuntor52r9fechado.equals("Disjuntor 52R9 Fechado") && passo == 12) {
                    passo = passo + 1;
                    relogio.passo = 13;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 13 realizado com sucesso !!!",
                            "Transferir do MT-2 para MT-R", JOptionPane.INFORMATION_MESSAGE);
                } else if (disjuntor52p3fechado.equals("Disjuntor 52P3 Fechado") && passo == 13) {
                    passo = passo + 1;
                    relogio.passo = 14;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 14 realizado com sucesso !!!",
                ...
                else if (seccionadora89c3aberta.equals("Seccionadora 89C3 Aberta") && passo == 14) {
                    passo = passo + 1;
                    relogio.passo = 15;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 15 realizado com sucesso !!!",
                            "Transferir do MT-2 para MT-R", JOptionPane.INFORMATION_MESSAGE);
                } else if (seccionadora89c3efechada.equals("Seccionadora 89C3E Fechada") && passo == 15) {
                    passo = passo + 1;
                    relogio.passo = 16;
                    relogio.rendimento();
                ...
                else if (seccionadora89c4aberta.equals("Seccionadora 89C4 Aberta") && passo == 16) {
                    passo = passo + 1;
                    relogio.passo = 17;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 17 realizado com sucesso !!!",
                            "Transferir do MT-2 para MT-R", JOptionPane.INFORMATION_MESSAGE);
                } else if (seccionadora89c4efechada.equals("Seccionadora 89C4E Fechada") && passo == 17) {
                    passo = passo + 1;
                    relogio.passo = 18;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 18 realizado com sucesso !!!",
                            "Transferir do MT-2 para MT-R", JOptionPane.INFORMATION_MESSAGE);
                } else if (disjuntor52c3fechado.equals("Disjuntor 52C3 Fechado") && passo == 18) {
                    passo = passo + 1;
                    relogio.passo = 19;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 19 realizado com sucesso !!!",
                            "Transferir do MT-2 para MT-R", JOptionPane.INFORMATION_MESSAGE);
                } else if (disjuntor52c4fechado.equals("Disjuntor 52C4 Fechado") && passo == 19) {
                    passo = passo + 1;
                    relogio.passo = 20;
                    relogio.rendimento();
                    relogio.setVisible(true);
                    ...
                    if (passo == 20 && disjuntor52c4fechado.equals("Disjuntor 52C4 Fechado") ||
                            passo != 20)
                        JOptionPane.showMessageDialog(null,
                                "OM para Transferir do MT-2 para MT-R ! Concluida com sucesso !!!",
                                "Transferir do MT-2 para MT-R", JOptionPane.INFORMATION_MESSAGE);
                    limparMemoria();
                } else {
                    Object[] options = { "Sim", "Nao", "Cancelar" };
        ...
        public void TransfMTRMT2() {
            if (TransfMTRMT2.equals("TransferirMTRMT2")) {
                ...
                if (disjuntor52p3aberto.equals("Disjuntor 52P3 Aberto") && passo == 0) {
                ...
                else if (seccionadora89p3eaberta.equals("Seccionadora 89P3E Aberta") && passo == 1) {
                    passo = passo + 1;
                    relogio.passo = 2;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 2 realizado com sucesso !!!",
                ...
                else if (seccionadora89p3fechada.equals("Seccionadora 89P3 Fechada") && passo == 2) {
                    passo = passo + 1;
                    relogio.passo = 3;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 3 realizado com sucesso !!!",
                ...
                else if (seccionadora89r8eaberta.equals("Seccionadora 89R8E Aberta") && passo == 6) {
                    passo = passo + 1;
                    relogio.passo = 7;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 7 realizado com sucesso !!!",
                ...
                else if (seccionadora89r8fechada.equals("Seccionadora 89R8 Fechada") && passo == 7) {
                    passo = passo + 1;
                    relogio.passo = 8;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 8 realizado com sucesso !!!",
                ...
                else if (seccionadora89r9eaberta.equals("Seccionadora 89R9E Aberta") && passo == 10) {
                    passo = passo + 1;
                    relogio.passo = 11;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 11 realizado com sucesso !!!",
                            "Transferir do MT-R para MT-2", JOptionPane.INFORMATION_MESSAGE);
                } else if (seccionadora89r9fechada.equals("Seccionadora 89R9 Fechada") && passo == 11) {
                    passo = passo + 1;
                    relogio.passo = 12;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 12 realizado com sucesso !!!",
                ...
                else if (seccionadora89c3eaberta.equals("Seccionadora 89C3E Aberta") && passo == 14) {
                    passo = passo + 1;
                    relogio.passo = 15;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 15 realizado com sucesso !!!",
                            "Transferir do MT-R para MT-2", JOptionPane.INFORMATION_MESSAGE);
                } else if (seccionadora89c3fechada.equals("Seccionadora 89C3 Fechada") && passo == 15) {
                    passo = passo + 1;
                    relogio.passo = 16;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 16 realizado com sucesso !!!",
                ...
                else if (seccionadora89c4eaberta.equals("Seccionadora 89C4E Aberta") && passo == 16) {
                    passo = passo + 1;
                    relogio.passo = 17;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 17 realizado com sucesso !!!",
                            "Transferir do MT-R para MT-2", JOptionPane.INFORMATION_MESSAGE);
                } else if (seccionadora89c4fechada.equals("Seccionadora 89C4 Fechada") && passo == 17) {
                    passo = passo + 1;
                    relogio.passo = 18;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 1 realizado com sucesso !!!",
                    ...
                    if (passo == 20 && disjuntor52c4fechado.equals("Disjuntor 52C4 Fechado") ||
                            passo != 20)
                        JOptionPane.showMessageDialog(null,
                                "OM para Transferir do MT-R para MT-2 ! Concluida com sucesso !!!",
                                "Transferir do MT-R para MT-2", JOptionPane.INFORMATION_MESSAGE);
                    limparMemoria();
                } else {
                    Object[] options = { "Sim", "Nao", "Cancelar" };
        ...
        public void DeslProgRed2() {
            if (DeslProgRed2.equals("DeslProgRed2")) {
                relogio.quantpassos = 4;
                if (disjuntor52c3aberto.equals("Disjuntor 52C3 Aberto") && passo == 0) {
                    relogio.zeraOtempo();
                    relogio.iniciaTempo();
                    passo = passo + 1;
                    relogio.setVisible(true);
                    ...
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 1 realizado com sucesso !!!",
                            "Desligamento da Reduçao 2", JOptionPane.INFORMATION_MESSAGE);
                }

                else if (disjuntor52c4aberto.equals("Disjuntor 52C4 Aberto") && passo == 1) {
                    passo = passo + 1;
                    relogio.passo = 2;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 2 realizado com sucesso !!!",
                ...
                else if (disjuntor52r7aberto.equals("Disjuntor 52R7 Aberto") && passo == 2) {
                    passo = passo + 1;
                    relogio.passo = 3;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 3 realizado com sucesso !!!",
                ...
                else if (disjuntor52lvr2aberto.equals("Disjuntor 52LVR2 Aberto") && passo == 3) {
                    passo = passo + 1;
                    relogio.passo = 4;
                    relogio.rendimento();
                    relogio.setVisible(true);
                    ...
                    if (passo == 4 && disjuntor52lvr2aberto.equals("Disjuntor 52LVR2 Aberto") ||
                            passo != 4)
                        JOptionPane.showMessageDialog(null, "OM para Desligar a Reduçao 2 ! Concluida com sucesso !!!",
                                "Desligamento da Reduçao 2", JOptionPane.INFORMATION_MESSAGE);
                    limparMemoria();
                } else {
                    Object[] options = { "Sim", "Nao", "Cancelar" };
        ...
        public void NormRed2() {
            if (NormRed2.equals("NormalizacaoRed2")) {
                relogio.quantpassos = 4;
                if (disjuntor52lvr2fechado.equals("Disjuntor 52LVR2 Fechado") && passo == 0) {
                    relogio.zeraOtempo();
                    relogio.iniciaTempo();
                    passo = passo + 1;
                    relogio.setVisible(true);
                    ...
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 1 realizado com sucesso !!!",
                            "Normalizaçao da Reduçao 2", JOptionPane.INFORMATION_MESSAGE);
                }

                else if (disjuntor52r7fechado.equals("Disjuntor 52R7 Fechado") && passo == 1) {
                    passo = passo + 1;
                    relogio.passo = 2;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 2 realizado com sucesso !!!",
                ...
                else if (disjuntor52c3fechado.equals("Disjuntor 52C3 Fechado") && passo == 2) {
                    passo = passo + 1;
                    relogio.passo = 3;
                    relogio.rendimento();
                    JOptionPane.showMessageDialog(null, "Passo 3 realizado com sucesso !!!",
                ...
                else if (disjuntor52c4fechado.equals("Disjuntor 52C4 Fechado") && passo == 3) {
                    passo = passo + 1;
                    relogio.passo = 4;
                    relogio.rendimento();
                    relogio.setVisible(true);
                    relogio.atualizaTempo();
                    if (passo == 4 && disjuntor52lvr2fechado.equals("Disjuntor 52LVR2 Fechado") ||
                            passo != 4)
                        JOptionPane.showMessageDialog(null,
                                "OM para Normalizar a Reduçao 2 ! Concluida com sucesso !!!",
                                "Normalizaçao da Reduçao 2", JOptionPane.INFORMATION_MESSAGE);
                    limparMemoria();
                } else {
                    Object[] options = { "Sim", "Nao", "Cancelar" };
    ...
    public static void main(String args[]) {
        ...
        // InterfaceMT2 application = new InterfaceMT2();
    }
}